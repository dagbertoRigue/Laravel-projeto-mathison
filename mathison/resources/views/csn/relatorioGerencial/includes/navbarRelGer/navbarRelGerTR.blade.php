                ...
                <li>
                  ...
                  <div class="form-group">
                    ...
                    "Helvetica Neue",Helvetica,Arial,sans-serif;">
                        ...
                        <option value=""> Termografia Isolamento</option>
                        ...
                        <option value="/preditiva.csn.br/relatorio-gerencial/analise-de-resistencia/ggop-pr/perfil"> Análise de Resistência</option>
                    </select>
                </div>
                </li>
            </ul>
