      ...
      <div class="col-md-8 col-md-offset-3">
        <div class="panel panel-default"style="background-color:#f1f1f1;">
            <div class="panel-heading">
                <strong><h4 style="color:#555; margin: 0 0 0px;">PR</h4></strong>
            </div>
            <div class="panel-body">
              <h5 style="color:#555; margin-top: -4px; margin-bottom: 4px;"><strong>Óleo</strong>
              <div class="panel-body">
                <div class="col-md-11">
                  <h6 style="color:#555; margin-top:10px; margin-left:10px;"><strong>Perfil das Linhas - Mês Atual - Coletados</strong></h6>
                  <div id="chartdivTermoPerfilColetados"></div>  <!-- Gráfico principal Termografia Perfil Coletados -->
                </div>
                <div class="col-md-6 col-md-offset-6">
                  <h6 style="color:#555; margin-top:10px; margin-left:10px;"><strong>Perfil das Linhas - Mês Atual - Não Coletados</strong></h6>
