        ...
        <div class="col-md-9 col-md-offset-2">
          <div class="panel panel-default" style="background-color:#f1f1f1;">
            <div class="panel-heading">
              <strong><h4 style="color:#555; margin: 0 0 0px;letter-spacing:0px;">Análise de Resistência - GGOP-PR</h4></strong>
                                      ...
                                      <tbody>
                                        ...
                                        <tr style="border: 1px solid #ddd;">
                                          ...
                                          <td class="cab_cent" style="border: 0px solid #ddd;">
                                            <a href = "/preditiva.csn.br/laudos/resistencia/laudo/equipamento/{{$tb_normal[$key]['idLaudo']}}" target="_blank" class="btn buttondg" style="background: {{$tb_normal[$key]['colorStatus']}};border-top: 1px solid {{$tb_normal[$key]['colorStatus']}};
                                                                  border: 1px solid {{$tb_normal[$key]['colorStatus']}};">
                                              {{$tb_normal[$key]['idLaudo']}} RM <br> {{ date('d-m-Y', strtotime(substr($tb_normal[$key]['data'], 0, 10))) }}
                                            </a>
                                          </td>
                                        </tr>
                                        @endforeach
                                  ...
                                  <table id="tbl_alarme" width="100%" class="display table table-striped table-bordered table-hover" style="color:#555;margin-top:0px;margin-bottom:15px;">
                                    ...
                                    <tbody>
                                      ...
                                      <tr style="border: 1px solid #ddd;">
                                        ...
                                        <td class="cab_cent" style="border: 0px solid #ddd;">
                                          <a href="/preditiva.csn.br/laudos/resistencia/laudo/equipamento/{{$tb_alarme[$key]['idLaudo']}}" target="_blank" class="btn buttondg" style="background: {{$tb_alarme[$key]['colorStatus']}};border-top: 1px solid {{$tb_alarme[$key]['colorStatus']}};
                                                                border: 1px solid {{$tb_alarme[$key]['colorStatus']}};">
                                            {{$tb_alarme[$key]['idLaudo']}} RM <br> {{ date('d-m-Y', strtotime(substr($tb_alarme[$key]['data'], 0, 10))) }}
                                          </a>
                                        </td>
                                      </tr>
                                      @endforeach
                                  ...
                                  <table id="tbl_critico" width="100%" class="display table table-striped table-bordered table-hover" style="color:#555;margin-top:0px;margin-bottom:15px;">
                                    ...
                                    <tbody>
                                      ...
                                      <tr style="border: 1px solid #ddd;">
                                        ...
                                        <td class="cab_cent" style="border: 0px solid #ddd;">
                                          <a href="/preditiva.csn.br/laudos/resistencia/laudo/equipamento/{{$tb_critico[$key]['idLaudo']}}" target="_blank" class="btn buttondg" style="background: {{$tb_critico[$key]['colorStatus']}};border-top: 1px solid {{$tb_critico[$key]['colorStatus']}};
                                                                border: 1px solid {{$tb_critico[$key]['colorStatus']}};">
                                            {{$tb_critico[$key]['idLaudo']}} RM <br> {{ date('d-m-Y', strtotime(substr($tb_critico[$key]['data'], 0, 10))) }}
                                          </a>
                                        </td>
                                      </tr>
                                      @endforeach
                                    ...
                                    <table id="tbl_manutencao" width="100%" class="display table table-striped table-bordered table-hover" style="color:#555;margin-top:0px;margin-bottom:15px;">
                                      ...
                                      <tbody>
                                        ...
                                        <tr style="border: 1px solid #ddd;">
                                          ...
                                          <td class="cab_cent" style="border: 0px solid #ddd;">
                                            <a href="/preditiva.csn.br/laudos/resistencia/laudo/equipamento/{{$tb_manutencao[$key]['idLaudo']}}" target="_blank" class="btn buttondg" style="background: {{$tb_manutencao[$key]['colorStatus']}};border-top: 1px solid {{$tb_manutencao[$key]['colorStatus']}};
                                                                  border: 1px solid {{$tb_manutencao[$key]['colorStatus']}};">
                                              {{$tb_manutencao[$key]['idLaudo']}} RM <br> {{ date('d-m-Y', strtotime(substr($tb_manutencao[$key]['data'], 0, 10))) }}
                                            </a>
                                          </td>
                                        </tr>
                                        @endforeach
                                    ...
                                    <table id="tbl_standBy" width="100%" class="display table table-striped table-bordered table-hover" style="color:#555;margin-top:0px;margin-bottom:15px;">
                                      ...
                                      <tbody>
                                        ...
                                        <tr style="border: 1px solid #ddd;">
                                          ...
                                          <td class="cab_cent" style="border: 0px solid #ddd;">
                                            <a href="/preditiva.csn.br/laudos/resistencia/laudo/equipamento/{{$tb_critico[$key]['idLaudo']}}" target="_blank"  class="btn buttondg" style="background: {{$tb_standBy[$key]['colorStatus']}};border-top: 1px solid {{$tb_standBy[$key]['colorStatus']}};
                                                                  border: 1px solid {{$tb_standBy[$key]['colorStatus']}};">
                                              {{$tb_standBy[$key]['idLaudo']}} RM <br> {{ date('d-m-Y', strtotime(substr($tb_standBy[$key]['data'], 0, 10))) }}
                                            </a>
                                          </td>
                                        </tr>
                                        @endforeach
                  ...
                  <div class="panel panel-default">
                    <div class="panel-body">
                      <div id="g1-perfil1" class="tabcontent w3-animate-right">
                        <div id="chartdivPerfil" style="margin-top:0px;margin-bottom:20px;cursor: pointer;"></div>
                      ...
                      <div id="g1-perfil2" class="tabcontent w3-animate-right">
                        <div id="chartdivPerfil2" style="margin-top:0px; margin-bottom:20px;"></div>
                        <div class="col-md-12" style="margin-top:-10px;">
                          <div class="col-md-1 col-md-offset-10">
                            <div class="w3-container">
                      ...
                      <div id="g1-status" class="tabcontent w3-animate-right">
                        <div id="chartdivStatus" style="margin-top:0px; margin-bottom:20px;;"></div>
                        <div class="col-md-12" style="margin-top:-10px;">
                          <div class="col-md-1 col-md-offset-10">
                            <div class="w3-container">
                      ...
                      <div id="g1-anormalidades" class="tabcontent w3-animate-right">
                        <div id="chartdivAnormalidades" style="margin-top:0px; margin-bottom:20px;"></div>
                        <div class="col-md-12" style="margin-top:-10px;">
                          <div class="col-md-1 col-md-offset-10">
                            <div class="w3-container">
                      ...
                      <div id="g1-problemas" class="tabcontent w3-animate-right">
                        <div id="chartdivProblemas" style="margin-top:0px; margin-bottom:20px;"></div>
                        <div class="col-md-12" style="margin-top:-10px;">
                          <div class="col-md-1 col-md-offset-10">
                            <div class="w3-container">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-body">
                      <div id="g2-perfil1" class="tabcontent w3-animate-zoom">
                        <div id="chartdivPerfil_2" style="margin-top:0px;margin-bottom:20px;cursor: pointer;"></div>
                        <div class="col-md-12" style="margin-top:-10px;">
                          <div class="col-md-1 col-md-offset-10">
                            <div class="w3-container">
                      ...
                      <div id="g2-perfil2" class="tabcontent w3-animate-zoom">
                        <div id="chartdivPerfil2_2" style="margin-top:0px; margin-bottom:20px;"></div>
                        <div class="col-md-12" style="margin-top:-10px;">
                          <div class="col-md-1 col-md-offset-10">
                            <div class="w3-container">
                      ...
                      <div id="g2-status" class="tabcontent w3-animate-zoom">
                        <div id="chartdivStatus_2" style="margin-top:0px; margin-bottom:20px;"></div>
                        <div class="col-md-12" style="margin-top:-10px;">
                          <div class="col-md-1 col-md-offset-10">
                            <div class="w3-container">
                      ...
                      <div id="g2-anormalidades" class="tabcontent w3-animate-zoom">
                        <div id="chartdivAnormalidades_2" style="margin-top:0px; margin-bottom:20px;"></div>
                        <div class="col-md-12" style="margin-top:-10px;">
                          <div class="col-md-1 col-md-offset-10">
                            <div class="w3-container">
                      ...
                      <div id="g2-problemas" class="tabcontent w3-animate-zoom">
                        <div id="chartdivProblemas_2" style="margin-top:0px; margin-bottom:20px;"></div>
                        <div class="col-md-12" style="margin-top:-10px;">
                          <div class="col-md-1 col-md-offset-10">
                            <div class="w3-container">
...
function openCity(evt, cityName) {
    ...
    //mostra a tab atual e adiciona um "active" na classe do bot�o que abriu a tab
    aux1 = aux2;
    aux2 = cityName;
    var a1 = g1.concat(aux1);
    var b1 = g2.concat(aux2);
