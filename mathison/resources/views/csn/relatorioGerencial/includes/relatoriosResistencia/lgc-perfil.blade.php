  ...
  <script>
    var chart = AmCharts.makeChart( "chartdivTermoPerfilColetados", {
      ...
      "dataProvider": [ {
        ...
        "color": "#db1111",
        "value": {!!$lgc_critico!!},
        "mPercents": {!!$lgc_criticoP!!}
      }, {
        "status": "Alarme",
        "color": "#FCD202",
        "value": {!!$lgc_alarme!!},
        "mPercents": {!!$lgc_alarmeP!!}
      }, {
        "status": "Normal",
        "color": "#2d9b1a",
        "value": {!!$lgc_normal!!},
        "mPercents": {!!$lgc_normalP!!}
      } ],
      "valueField": "value",
      "colorField": "color",
      "titleField": "status",
  ...
  <!-- Chart code -->
    var chart = AmCharts.makeChart( "chartdiv1", {
      ...
      "dataProvider": [ {
        "status": "Manutenção",
        "color": "#777d84",
        "value": {!! $lgc_manutencao !!},
        "mPercents": {!!$lgc_manutencaoP!!}
      }, {
        "status": "Stand By",
        "color": "#3e658e",
        "value": {!! $lgc_standBy !!},
        "mPercents": {!!$lgc_standByP!!}
      } ],
      "valueField": "value",
      "colorField": "color",
      "titleField": "status",
