          ...
          <div class="panel panel-default"style="background-color:#f1f1f1;">
            ...
            <div class="panel-body">
              <div class="row" style="margin-top: 0px;margin-bottom:0px;">
                <h5 style="color:#555; margin-top:-4px; margin-bottom: 4px; margin-left:15px;"><strong>Análise de Resistência</strong>
              </div>
              <div class="col-md-12">
                <div class="col-md-6">
                  <h6 style="color:#555; margin-top:10px;"><strong>Status dos Pontos - Coletados Mês Atual</strong></h6>
                  <div id="chartdivTermoPerfilColetados"></div>  <!-- Gráfico principal Vibração Perfil Coletados -->
                </div>
                <div class="col-md-6">
              ...
              <div class="panel-body">
                <div class="col-md-11">
                  ...
                  <div id="chartdiv"></div>  <!-- Gráfico principal Vibração Perfil Coletados -->
                  <hr>
                </div>
              </div>
            </div>
