        ...
        <div class="col-md-9 col-md-offset-2">
          <div class="panel panel-default" style="background-color:#f1f1f1;">
            <div class="panel-heading">
              <strong><h4 style="color:#555; margin: 0 0 0px;letter-spacing:0px;">Análise de Vibração - GGOP-PR</h4></strong>
                                      ...
                                      <tbody>
                                        ...
                                        <tr style="border: 1px solid #ddd;">
                                          ...
                                          <td class="cab_cent" style="border: 0px solid #ddd;">
                                            <a href = "/preditiva.csn.br/laudos/vibracao/laudo/equipamento/{{$tb_normal[$key]['idLaudo']}}" target="_blank" class="btn buttondg" style="background: {{$tb_normal[$key]['colorStatus']}};border-top: 1px solid {{$tb_normal[$key]['colorStatus']}};
                                                                  border: 1px solid {{$tb_normal[$key]['colorStatus']}};">
                                              {{$tb_normal[$key]['idLaudo']}} VB <br> {{ date('d-m-Y', strtotime(substr($tb_normal[$key]['data'], 0, 10))) }}
                                            </a>
                                          </td>
                                        </tr>
                                        @endforeach
                                  ...
                                  <table id="tbl_alarme" width="100%" class="display table table-striped table-bordered table-hover" style="color:#555;margin-top:0px;margin-bottom:15px;">
                                    ...
                                    <tbody>
                                      ...
                                      <tr style="border: 1px solid #ddd;">
                                        ...
                                        <td class="cab_cent" style="border: 0px solid #ddd;">
                                          <a href="/preditiva.csn.br/laudos/vibracao/laudo/equipamento/{{$tb_alarme[$key]['idLaudo']}}" target="_blank" class="btn buttondg"
                                            ...
                                            {{$tb_alarme[$key]['idLaudo']}} VB <br> {{ date('d-m-Y', strtotime(substr($tb_alarme[$key]['data'], 0, 10))) }}
                                          </a>
                                        </td>
                                      </tr>
                                      @endforeach
                                  ...
                                  <table id="tbl_critico" width="100%" class="display table table-striped table-bordered table-hover" style="color:#555;margin-top:0px;margin-bottom:15px;">
                                    ...
                                    <tbody>
                                      ...
                                      <tr style="border: 1px solid #ddd;">
                                        ...
                                        <td class="cab_cent" style="border: 0px solid #ddd;">
                                          <a href="/preditiva.csn.br/laudos/vibracao/laudo/equipamento/{{$tb_critico[$key]['idLaudo']}}" target="_blank" class="btn buttondg" style="background: {{$tb_critico[$key]['colorStatus']}};border-top: 1px solid {{$tb_critico[$key]['colorStatus']}};
                                                                border: 1px solid {{$tb_critico[$key]['colorStatus']}};">
                                            {{$tb_critico[$key]['idLaudo']}} VB <br> {{ date('d-m-Y', strtotime(substr($tb_critico[$key]['data'], 0, 10))) }}
                                          </a>
                                        </td>
                                      </tr>
                                      @endforeach
                                    ...
                                    <table id="tbl_manutencao" width="100%" class="display table table-striped table-bordered table-hover" style="color:#555;margin-top:0px;margin-bottom:15px;">
                                      ...
                                      <tbody>
                                        ...
                                        <tr style="border: 1px solid #ddd;">
                                          ...
                                          <td class="cab_cent" style="border: 0px solid #ddd;">
                                            <a href="/preditiva.csn.br/laudos/vibracao/laudo/equipamento/{{$tb_manutencao[$key]['idLaudo']}}" target="_blank" class="btn buttondg" style="color:#eee;background: {{$tb_manutencao[$key]['colorStatus']}};border-top: 1px solid {{$tb_manutencao[$key]['colorStatus']}};
                                                                  border: 1px solid {{$tb_manutencao[$key]['colorStatus']}};">
                                              {{$tb_manutencao[$key]['idLaudo']}} VB <br> {{ date('d-m-Y', strtotime(substr($tb_manutencao[$key]['data'], 0, 10))) }}
                                            </a>
                                    ...
                                    <table id="tbl_standBy" width="100%" class="display table table-striped table-bordered table-hover" style="color:#555;margin-top:0px;margin-bottom:15px;">
                                      ...
                                      <tbody>
                                        ...
                                        <tr style="border: 1px solid #ddd;">
                                          ...
                                          <td class="cab_cent" style="border: 0px solid #ddd;">
                                            <a href="/preditiva.csn.br/laudos/vibracao/laudo/equipamento/{{$tb_standBy[$key]['idLaudo']}}" target="_blank" class="btn buttondg" style="color:#ccc;background: {{$tb_standBy[$key]['colorStatus']}};border-top: 1px solid {{$tb_standBy[$key]['colorStatus']}};
                                                                  border: 1px solid {{$tb_standBy[$key]['colorStatus']}};">
                                              {{$tb_standBy[$key]['idLaudo']}} VB <br> {{ date('d-m-Y', strtotime(substr($tb_standBy[$key]['data'], 0, 10))) }}
                                            </a>
                                          </td>
                                        </tr>
                                        @endforeach
                            ...
                            <table id="tb_anormalidades" width="100%" class="display table table-striped table-bordered table-hover" style="color:#555;margin-top:0px;margin-bottom:15px;">
                              ...
                              <tbody>
                                ...
                                <tr style="border: 1px solid #ddd;">
                                  ...
                                  <td class="cab_cent" style="border: 0px solid #ddd;">
                                    <a href="/preditiva.csn.br/laudos/vibracao/laudo/equipamento/{{$tb_anormalidades[$key]['idLaudo']}}" target="_blank" class="btn buttondg" style="color:#888;background: {{$tb_anormalidades[$key]['colorStatus']}};border-top: 1px solid {{$tb_anormalidades[$key]['colorStatus']}};
