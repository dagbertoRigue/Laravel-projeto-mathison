    ...
    <script>
      var chart = AmCharts.makeChart( "chartdivTermoPerfilColetados", {
        ...
        "dataProvider": [ {
          ...
          "color": "#db1111",
          "value": {!!$lds_critico!!},
          "mPercents": {!!$lds_criticoP!!}
        }, {
          "status": "Alarme",
          "color": "#FCD202",
          "value": {!!$lds_alarme!!},
          "mPercents": {!!$lds_alarmeP!!}
        }, {
          "status": "Normal",
          "color": "#2d9b1a",
          "value": {!!$lds_normal!!},
          "mPercents": {!!$lds_normalP!!}
        } ],
        "valueField": "value",
        "colorField": "color",
        "titleField": "status",
    ...
    <script>
      var chart = AmCharts.makeChart( "chartdiv1", {
        ...
        "dataProvider": [ {
          "status": "Manutenção",
          "color": "#777d84",
          "value": {!! $lds_manutencao !!},
          "mPercents": {!!$lds_manutencaoP!!}
        }, {
          "status": "Stand By",
          "color": "#3e658e",
          "value": {!! $lds_standBy !!},
          "mPercents": {!!$lds_standByP!!}
        } ],
        "valueField": "value",
        "colorField": "color",
        "titleField": "status",
