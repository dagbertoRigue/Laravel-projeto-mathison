    ...
    <script>
      var chart = AmCharts.makeChart( "chartdivTermoPerfilColetados", {
        ...
        "dataProvider": [ {
          ...
          "color": "#db1111",
          "value": {!!$lrf_critico!!},
          "mPercents": {!!$lrf_criticoP!!}
        }, {
          "status": "Alarme",
          "color": "#FCD202",
          "value": {!!$lrf_alarme!!},
          "mPercents": {!!$lrf_alarmeP!!}
        }, {
          "status": "Normal",
          "color": "#2d9b1a",
          "value": {!!$lrf_normal!!},
          "mPercents": {!!$lrf_normalP!!}
        } ],
        "valueField": "value",
        "colorField": "color",
        "titleField": "status",
    ...
    <script>
      var chart = AmCharts.makeChart( "chartdiv1", {
        ...
        "dataProvider": [ {
          "status": "Manutenção",
          "color": "#777d84",
          "value": {!! $lrf_manutencao !!},
          "mPercents": {!!$lrf_manutencaoP!!}
        }, {
          "status": "Stand By",
          "color": "#3e658e",
          "value": {!! $lrf_standBy !!},
          "mPercents": {!!$lrf_standByP!!}
        } ],
        "valueField": "value",
        "colorField": "color",
        "titleField": "status",
