    ...
    <script>
      var chart = AmCharts.makeChart( "chartdivTermoPerfilColetados", {
        ...
        "dataProvider": [ {
          ...
          "color": "#db1111",
          "value": {!!$lpc_critico!!},
          "mPercents": {!!$lpc_criticoP!!}
        }, {
          "status": "Alarme",
          "color": "#FCD202",
          "value": {!!$lpc_alarme!!},
          "mPercents": {!!$lpc_alarmeP!!}
        }, {
          "status": "Normal",
          "color": "#2d9b1a",
          "value": {!!$lpc_normal!!},
          "mPercents": {!!$lpc_normalP!!}
        } ],
        "valueField": "value",
        "colorField": "color",
        "titleField": "status",
    ...
    <script>
      var chart = AmCharts.makeChart( "chartdiv1", {
        ...
        "dataProvider": [ {
          "status": "Manutenção",
          "color": "#777d84",
          "value": {!! $lpc_manutencao !!},
          "mPercents": {!!$lpc_manutencaoP!!}
        }, {
          "status": "Stand By",
          "color": "#3e658e",
          "value": {!! $lpc_standBy !!},
          "mPercents": {!!$lpc_standByP!!}
        } ],
        "valueField": "value",
        "colorField": "color",
        "titleField": "status",
