...
<!-- - - - - - - - - - - - GRÁFICO UTILIDADES PERFIL DA LINHA - - - - - - - - - - - -->
    ...
    <script>
      var chart = AmCharts.makeChart( "chartdivTermoPerfilColetados", {
        ...
        "dataProvider": [ {
          ...
          "color": "#db1111",
          "value": {!!$uti_critico!!},
          "mPercents": {!!$uti_criticoP!!}
        }, {
          "status": "Alarme",
          "color": "#FCD202",
          "value": {!!$uti_alarme!!},
          "mPercents": {!!$uti_alarmeP!!}
        }, {
          "status": "Normal",
          "color": "#2d9b1a",
          "value": {!!$uti_normal!!},
          "mPercents": {!!$uti_normalP!!}
        } ],
        "valueField": "value",
        "colorField": "color",
        "titleField": "status",
    ...
    <script>
      var chart = AmCharts.makeChart( "chartdiv1", {
        ...
        "dataProvider": [ {
          "status": "Manutenção",
          "color": "#777d84",
          "value": {!! $uti_manutencao !!},
          "mPercents": {!!$uti_manutencaoP!!}
        }, {
          "status": "Stand By",
          "color": "#3e658e",
          "value": {!! $uti_standBy !!},
          "mPercents": {!!$uti_standByP!!}
        } ],
        "valueField": "value",
        "colorField": "color",
        "titleField": "status",
