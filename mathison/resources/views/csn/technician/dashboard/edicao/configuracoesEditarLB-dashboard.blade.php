...
<div id="wrapper-side" style="margin-top: 50px;">
  ...
  <form action="/preditiva.csn.br/tecnico-preditiva/configuracoes/editar/atividade/oleo-pag2" method="get" name="myform"  id="myform">
          ...
          <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default" style="background-color:#f1f1f1;">
              <div class="panel-heading">
                <strong>Análise de Lubrificantes: Editar atividade</strong>
              </div>
...
$(document).ready(function() {
  $('select[name="negocio"]').on('change', function() {
      ...
      if(negocioID) {
          $.ajax({
              url: '/preditiva.csn.br/tecnico-preditiva/configuracoes/atividades/oleo/ajax/'+negocioID,
              type: "GET",
              dataType: "json",
