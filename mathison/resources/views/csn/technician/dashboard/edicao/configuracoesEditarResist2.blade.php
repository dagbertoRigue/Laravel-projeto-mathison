...
<div id="wrapper-side" style="margin-top: 50px;">
  ...
  <form action="/preditiva.csn.br/tecnico-preditiva/configuracoes/editar/atividade/resistencia/adiciona" method="post" name="myform" id="myform" enctype="multipart/form-data">
                        ...
                        <div class="row" style="padding-top:15px; padding-bottom:15px;">
                          <div class="col-md-12" style="padding-right: 0px; padding-left: 0px;">
                            <div class="form-group">
                              <div class="col-md-7">
                                <div class="sidebar">
                                  <div class="form-group" id="imagemRM" style="padding-top:15px;">
                                    <strong><label>Selecione Imagem:</label></strong>
                                    {{ csrf_field() }}
                                    <input type="file" name="imagemRM">
                                  </div>
                                  <label for="title">Imagem atual:</label>
                                  <input type="text" id="imagem" name="imagem" value="{{substr($imagem, 27, 150)}}" style="width: 100%; background:#eee;" disabled="disabled"><br>
                                </div>
                              </div>
                  ...
                  <div class="row" style="padding-top:15px; padding-bottom:15px;">
                    <div class="col-md-8">
                      <div class="col-md-3" style="padding: 5px 5px 5px 5px;">
                        <a href={{ route('configEditarResist.dashboard')}} class="btn btn-primary btn-block">Voltar</a>
                      </div>
                      <div class="col-md-3" style="padding: 5px 5px 5px 5px;">
...
$(document).ready(function() {
  $('select[name="negocio"]').on('change', function() {
      ...
      if(negocioID) {
          $.ajax({
              url: '/preditiva.csn.br/tecnico-preditiva/configuracoes/atividades/resistencia/ajaxZero/'+negocioID,
              type: "GET",
              dataType: "json",
