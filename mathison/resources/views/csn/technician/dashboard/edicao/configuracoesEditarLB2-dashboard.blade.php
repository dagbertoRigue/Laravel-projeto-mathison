...
<div id="wrapper-side" style="margin-top: 50px;">
  ...
  <form action="/preditiva.csn.br/tecnico-preditiva/configuracoes/editar/atividade/oleo/adiciona" method="post" name="myform" id="myform" enctype="multipart/form-data">
          ...
          <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default" style="background-color:#f1f1f1;">
              <div class="panel-heading">
                <strong>Análise de Lubrificantes</strong>
              </div>
                  ...
                  <div class="row" style="padding-top:15px; padding-bottom:15px;">
                    <div class="col-md-8">
                      <div class="col-md-3" style="padding: 5px 5px 5px 5px;">
                        <a href={{ route('configEditarOleo.dashboard')}} class="btn btn-primary btn-block">Voltar</a>
                      </div>
                      <div class="col-md-3" style="padding: 5px 5px 5px 5px;">
...
$(document).ready(function() {
  $('select[name="negocio"]').on('change', function() {
      ...
      if(negocioID) {
          $.ajax({
              url: '/preditiva.csn.br/tecnico-preditiva/configuracoes/atividades/oleo/ajaxZero/'+negocioID,
              type: "GET",
              dataType: "json",
