...
<div id="wrapper-side" style="margin-top: 50px;">
  ...
  <form action="/preditiva.csn.br/tecnico-preditiva/configuracoes/editar/atividade/termografia-isolamento-pag2" method="get" name="myform"  id="myform">
          ...
          <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default" style="background-color:#f1f1f1;">
              <div class="panel-heading">
                <strong>Termografia de Isolamento: Editar atividade</strong>
              </div>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTable" name="dataTable">
                              ...
                              <tbody>
                                ...
                                <tr class="odd gradeX">
                                  ...
                                  <td>{{substr($t->image_ativ, 32, 150)}}</td>
                                  <td>{{$t->periodicity}}</td>
                                </tr>
                                @endforeach
                            </tbody>
